...
Class.prototype._makeAccessors = function() {
  ...
  proto.addGetters = function(props) {
    if (!Array.isArray(props)) props = [].slice.call(arguments);
    props.forEach(function(prop) {
      proto['get' + capitalize(prop)] = function() {
        return _(this)[prop];
      };
    });
  };

  proto.addSetters = function(props) {
    if (!Array.isArray(props)) props = [].slice.call(arguments);
    props.forEach(function(prop) {
      proto['set' + capitalize(prop)] = function(value) {
        _(this)[prop] = value;
      };
    });
  };

  proto.addAccessors = function() {
    proto.addGetters.apply(proto, arguments);
    proto.addSetters.apply(proto, arguments);
  };
};
